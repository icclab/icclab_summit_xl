...
def gripper_client_2(value):
    pub = rospy.Publisher('/summit_xl/gripper_joint_trajectory_controller/command', JointTrajectory, queue_size=10)
    trajectory = JointTrajectory()
    trajectory.points =  [JointTrajectoryPoint(positions=[value], velocities=[0], time_from_start=rospy.Duration(1.0))]
    trajectory.joint_names.append("robotiq_85_left_knuckle_joint")
...
def gripper_client(value):
    ...
    client = actionlib.SimpleActionClient(
        '/summit_xl/gripper_action_controller/gripper_cmd',  # namespace of the action topics
