...
screen -S summit -p robot -X exec roslaunch icclab_summit_xl irlab_summit_xl_amcl.launch sim:=false
...
screen -S summit -p ros2 -X exec docker run -it --privileged --network=host --ipc=host --pid=host --env UID=$(id -u) --env GID=$(id -g) -v /home/summit:/home/summit robopaas/rosdocked-humble-cpu bash -c "export ROS_DISTRO=humble; export RMW_IMPLEMENTATION=rmw_cyclonedds_cpp; export CYCLONEDDS_URI=file:////home/summit/cyclonedds-mc.xml; watch ros2 node list"
